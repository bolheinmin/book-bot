...
const feedback_questions = {
    "que1": "please enter full name",
    "que2": "please enter message",
}
...
function handleQuickReply(sender_psid, received_message) {
    ...
    if (received_message.startsWith("visit:")) {
        ...
        switch (received_message) {
            case "wedding-photo":
                showWeddingPhoto(sender_psid);
                break;
            case "donation-photo":
                showDonationPhoto(sender_psid);
                break;
            case "graduation-photo":
                showGraduationPhoto(sender_psid);
                break;
            case "on":
    ...
    if (payload.startsWith("Package:")) {
        ...
        switch (payload) {
            ...
            case "view-package":
                ...
                break;
            case "view-feedback":
                showFeedback(sender_psid);
                break;
            case "view-photo":
                showPhoto(sender_psid);
                break;
            case "yes":
...
const showFeedback = (sender_psid) => {
    let response = {
        "attachment": {
            "type": "template",
            "payload": {
...
const showPhoto = (sender_psid) => {
    let response = {
        "text": " ok which event of image want to view",
        "quick_replies": [{
            "content_type": "text",
            "title": "Wedding",
            "payload": "wedding-photo"
        }, {
            "content_type": "text",
            "title": "Graduation",
            "payload": "graduation-photo"
        }, {
            "content_type": "text",
            "title": "Donation",
            "payload": "donation-photo"
        }]
    };
    callSend(sender_psid, response);
}

const showWeddingPhoto = (sender_psid) => {
    let response = {
        "attachment": {
            "type": "template",
            "payload": {
...
const showDonationPhoto = (sender_psid) => {
    let response = {
        "attachment": {
            "type": "template",
            "payload": {
...
const showGraduationPhoto = (sender_psid) => {
    let response = {
        "attachment": {
            "type": "template",
            "payload": {
